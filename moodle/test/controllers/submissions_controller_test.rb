...
class SubmissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create submission" do
    assert_difference("Submission.count") do
      post submissions_url, params: { submission: { assignment_id: @submission.assignment_id, student_id: @submission.student_id } }
    end
  ...
  test "should update submission" do
    patch submission_url(@submission), params: { submission: { assignment_id: @submission.assignment_id, student_id: @submission.student_id } }
